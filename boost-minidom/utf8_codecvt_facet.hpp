...
// Note:(Julien Cayzac). I included this source in my DOM manipulation library,
// MiniDOM. The following line is not part of the original source.
#include "utf8_config.hpp"
