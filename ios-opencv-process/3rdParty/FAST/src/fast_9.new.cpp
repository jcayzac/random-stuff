...
int 
fast9_corner_score(const byte * p, const int pixel[], int bstart)
{
	int bmin = bstart;
	int bmax = 255;
	int b = (bmax + bmin) >> 1;
...
static void 
make_offsets(int pixel[], int row_stride)
{
...
int *
fast9_score(const byte * i, int stride, xy * corners, int num_corners, int b)
{
	//int *scores = (int *) malloc(sizeof(int) * num_corners);
	int *scores = (int *) gFASTMem.setSizeInt(FASTMem::SLOT_SCORE, num_corners);
	int n;
...
xy *
fast9_detect(const byte * im, int xsize, int ysize, int stride, int b, int *ret_num_corners)
{
	int num_corners = 0;
	xy *ret_corners;
	int rsize = 512;
...
ret_corners = (xy *) gFASTMem.setSizeXY(FASTMem: :SLOT_DETECT, rsize);
	make_offsets(pixel, stride);
